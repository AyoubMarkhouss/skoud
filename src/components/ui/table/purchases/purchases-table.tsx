...
import AddPurchases from "@/components/forms/Addpurchases";
      ...
      <div>
        <div className="flex items-center md:flex-row gap-4 md:gap-0 flex-col-reverse justify-between py-4 ">
          ...
          <div className="md:flex w-full md:w-fit gap-2 py-3 grid grid-cols-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="bg-teal-500 hover:bg-teal-600">اضافة</Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-end">
                    أنت على وشك إضافة منتج جديد
                  </AlertDialogTitle>
                  <AlertDialogDescription className="text-end">
                    يرجى ملء هذه الحقول بشكل صحيح
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AddPurchases />
              </AlertDialogContent>
